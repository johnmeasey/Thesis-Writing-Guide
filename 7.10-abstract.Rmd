...
Without downloading or reading any of the article, use the abstract as published on the literature database and attempt to fill in the entire table for each paper.
