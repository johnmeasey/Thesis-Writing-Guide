...
1. **The hypo-deductive model in science** – big questions in your field; reviewing the literature; how to write a hypothesis; citing the literature
1. **A model for thesis writing** – introduction; methods; results; discussion
1. **Nuts and bolts of writing** – sentences; paragraphs; logical arguments; examples; citation databases
1. **When science goes wrong** – publication bias; the evolution of bad science; rewards and retractions
1. **Preregistration** – transparency; the movement for Open Science; data curation
1. **Publishing your thesis chapters** – choosing a journal; preparing your submission; Open Access and reviewing models
1. **Peer Review** – writing a rebuttal; how to conduct peer review; 
1. **Your future in science** – mental health; networks; careers
